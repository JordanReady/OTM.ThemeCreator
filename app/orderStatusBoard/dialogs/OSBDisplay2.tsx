...
export default function OSBDisplay1({
  ...
  const renderOrderItem = (order: Order) => {
    ...
    return (
      <div className="secondOrderItem animate" key={order.CheckNumber}>
      ...
      <div className={`osb-dialog ${animate ? "animate" : ""}`}>
        ...
        <div className="content">
          <div className="orderlist">
            <div id="secondListView1">
              {preppingOrders.map(renderOrderItem)}
            </div>
            <div id="secondListView2">{readyOrders.map(renderOrderItem)}</div>
          </div>
